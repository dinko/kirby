...
class Str
{
     ...
     * @return int
     */
    public static function similarity(string $first, string $second, float &$percent = null): int
    {
        ...
        if ($similarity) {
            if ($pos1 && $pos2) {
                $similarity += static::similarity(mb_substr($first, 0, $pos1), mb_substr($second, 0, $pos2));
            }
